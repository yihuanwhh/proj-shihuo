<template>
  <div>
    <section id="city-list" class="city-list-container" style="display: block;">
      ...
      <section class="nav">
        <div class="nav-item" data-id="locate" @click="scrollToElement('#locate')">定位</div>

        <div class="nav-item" data-id="history" @click="scrollToElement('#history')">最近</div>

        <div class="nav-item" data-id="hot" @click="scrollToElement('#hot')">热门</div>
